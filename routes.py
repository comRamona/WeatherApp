...
weather_com_Glasgow = pywapi.get_weather_from_weather_com('UKXX0061')
...
g="Weather.com says: It is " + weather_com_Glasgow['current_conditions']['text'].lower() + " and " + weather_com_Glasgow['current_conditions']['temperature'] + "C now in Glasgow."
